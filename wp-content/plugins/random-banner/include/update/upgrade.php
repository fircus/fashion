...
function _bc_random_banner_table_create( $bc_random_banner, $charset_collate ) {
	require_once( ABSPATH . 'wp-admin/includes/upgrade.php' );
	$sql_create_table_bc_random_banner = "CREATE TABLE IF NOT EXISTS $bc_random_banner (
		id mediumint(9) NOT NULL AUTO_INCREMENT,
...
function _bc_random_banner_option_table( $bc_random_banner_options, $bc_random_banner, $charset_collate ) {
	$sql_create_table_bc_random_banner_options = "CREATE TABLE IF NOT EXISTS $bc_random_banner_options (
  id mediumint(9) NOT NULL AUTO_INCREMENT,

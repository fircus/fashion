...
function ldc_like_counter_c($text="Likes: ",$post_id=NULL)
{
    ...
    $ldc_return = ' <a class="like" href="javascript:void(0)" onclick="alter_ul_post_values(this,'.$post_id.',\'c_like\');">
                        <img src="'.get_site_url().'/wp-content/themes/best-people/images/like.png">
                        <span>'.get_post_ul_meta($post_id,"c_like").'</span>
                    </a>';
    return $ldc_return;
}
